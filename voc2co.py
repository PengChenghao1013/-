...
PRE_DEFINE_CATEGORIES = PRE_DEFINE_CATEGORIES = {
    'aeroplane': 1,
    'bicycle': 2,
    'bird': 3,
    'boat': 4,
...
def parse_args():
    ...
    parser.add_argument('--devkit_path',default=r'I:\datasets\VOCdevkit',help='pascal voc devkit path')  # voc根路径 里面存放的是VOC2007和VOC2012两个子文件夹
